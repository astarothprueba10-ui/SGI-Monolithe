-- ============================================================================
-- SIGI MONOLITHE - SEED DE DATOS (CATALOGOS Y CONFIGURACIONES)
...
('CANCELADO', 'Cancelado',
 'Proyecto cancelado', 6) ON CONFLICT DO NOTHING;
...
('CANCELADA', 'Cancelada',
 'Etapa cancelada', 5) ON CONFLICT DO NOTHING;
...
('CERRADA', 'Cerrada',
 'Manzana sin operaciones disponibles', 4) ON CONFLICT DO NOTHING;
...
('RUC', 'RUC', 'Registro Único de Contribuyentes', 11, 11, TRUE, 4) ON CONFLICT DO NOTHING;
...
('CELULAR', 'Celular', 2),
('TELEFONO', 'Teléfono', 3),
('WHATSAPP', 'WhatsApp', 4) ON CONFLICT DO NOTHING;
...
('DESCARTADO', 'Descartado',
 'Prospecto descartado por criterios comerciales', TRUE, 8) ON CONFLICT DO NOTHING;
...
('OTRO', 'Otro', 10) ON CONFLICT DO NOTHING;
...
('OTRO', 'Otro', 7) ON CONFLICT DO NOTHING;
...
VALUES
('PEN', 'Sol peruano', 'S/'),
('USD', 'Dólar estadounidense', '$') ON CONFLICT DO NOTHING;
...
('CANCELADA', 'Cancelada',
 'Reserva cancelada', TRUE, 5) ON CONFLICT DO NOTHING;
...
('ANULADA', 'Anulada',
 'Venta anulada', TRUE, 5) ON CONFLICT DO NOTHING;
...
('ANULADO', 'Anulado',
 'Contrato anulado', TRUE, 6) ON CONFLICT DO NOTHING;
