-- =============================================================================
-- SCRIPT DE CREACION DE TABLAS PARA SUPABASE (POSTGRESQL)
-- Proyecto: SGI-Monolithe (Sistema de Gestion Inmobiliaria)
-- Compatible con PostgreSQL 15+ y Supabase Database
-- =============================================================================
...
CREATE TABLE estado_proyecto (
    id_estado_proyecto SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE estado_etapa (
    id_estado_etapa SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE estado_manzana (
    id_estado_manzana SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE estado_lote (
    id_estado_lote SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE tipo_contacto (
  ...
  CREATE TABLE estado_prospecto (
    id_estado_prospecto SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE tipo_seguimiento (
 ...
 CREATE TABLE tipo_consentimiento (
  ...
  CREATE TABLE estado_reserva (
    id_estado_reserva SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  ...
  CREATE TABLE estado_venta (
    id_estado_venta SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  ...
  CREATE TABLE estado_contrato (
    id_estado_contrato SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  ...
  CREATE TABLE estado_usuario (
    id_estado_usuario SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  ...
  CREATE TABLE estado_plan_pago (
    id_estado_plan_pago SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  ...
  CREATE TABLE estado_cuota (
    id_estado_cuota SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
 ...
 CREATE TABLE estado_voucher (
    id_estado_voucher SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  ...
  CREATE TABLE estado_pago (
    id_estado_pago SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  ...
  CREATE TABLE estado_asesor (
    id_estado_asesor SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE estado_comision (
    id_estado_comision SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  ...
  CREATE TABLE estado_publicacion (
    id_estado_publicacion SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE tipo_seccion (
 ...
 CREATE TABLE uso_multimedia (
  ...
  CREATE TABLE estado_consulta_web (
    id_estado_consulta_web SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE estado_envio (
    id_estado_envio SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE tipo_movimiento (
  ...
  CREATE TABLE estado_movimiento (
    id_estado_movimiento SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
-- ----- 2. CORE DEL NEGOCIO --------
 ...
 -- TABLA CORE_PERSONAS 
  ...
  CREATE TABLE documento_identidad (
    ...
    clave_principal VARCHAR(100) GENERATED ALWAYS AS (
            CASE
                WHEN principal = TRUE
                     AND activo = TRUE
 ...
 CREATE TABLE direccion (
    ...
    clave_principal VARCHAR(150) GENERATED ALWAYS AS (
            CASE
                WHEN principal = TRUE
                     AND activo = TRUE
 ...
 CREATE TABLE usuario (
    ...
    fecha_cambio_clave TIMESTAMPTZ,
 ...
 CREATE TABLE permiso (
  ...
  CREATE TABLE asignacion_rol (
    ...
    clave_vigente VARCHAR(100) GENERATED ALWAYS AS (
            CASE
                WHEN activo = TRUE
...
CREATE TABLE etapa (
    ...
    id_estado_etapa SMALLINT NOT NULL,
...
CREATE TABLE manzana (
    ...
    id_proyecto BIGINT NOT NULL,
    id_estado_manzana SMALLINT NOT NULL,
...
CREATE TABLE zona (
 ...
 CREATE TABLE etapa_comercial (
  ...
  CREATE TABLE tarifa (
    ...
    clave_vigente VARCHAR(200) GENERATED ALWAYS AS (
            CASE
                WHEN activo = TRUE
  ...
  CREATE TABLE ajuste_precio (
    ...
    clave_vigente VARCHAR(160) GENERATED ALWAYS AS (
            CASE
                WHEN activo = TRUE
                     AND fecha_hasta IS NULL
                THEN (id_proyecto)::text || '-' || (id_tipo_lote)::text || '-' || (id_tipo_ajuste_precio)::text || '-' || (COALESCE(id_moneda)::text || (0)::text
                )
                ELSE NULL
            END
        ) STORED,
...
CREATE TABLE lote (
    ...
    id_estado_lote SMALLINT NOT NULL,
...
CREATE TABLE precio_lote (
 ...
 CREATE TABLE plano_interactivo (
    ...
    etapa_version BIGINT GENERATED ALWAYS AS (
            COALESCE(id_etapa, 0)
        ) STORED,
    ...
    proyecto_vigente BIGINT GENERATED ALWAYS AS (
            CASE
                WHEN vigente = TRUE
    ...
    clave_etapa_vigente VARCHAR(100) GENERATED ALWAYS AS (
            CASE
                WHEN vigente = TRUE
...
-- ------- 5. CRM -----------------------------------
  ...
  CREATE TABLE prospecto (
    id_prospecto BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,

    id_persona BIGINT NOT NULL,
    id_estado_prospecto SMALLINT NOT NULL,
  ...
  CREATE TABLE interes_comercial (
    ...
    fecha_interes TIMESTAMPTZ NOT NULL
        DEFAULT CURRENT_TIMESTAMP(6),
...
-- ---- 6. VENTAS ------------
 ...
 CREATE TABLE venta (
    ...
    id_lote BIGINT NOT NULL,
    id_reserva BIGINT,
    id_estado_venta SMALLINT NOT NULL,
  ...
  CREATE TABLE participacion_venta (
    ...
    id_venta_titular BIGINT GENERATED ALWAYS AS (
            CASE
                WHEN titular = TRUE
                THEN id_venta
                ELSE NULL
  ...
  CREATE TABLE contrato (
    ...
    id_estado_contrato SMALLINT NOT NULL,
    id_usuario BIGINT,
  ...
  CREATE TABLE documento_contractual (
    ...
    id_contrato_vigente BIGINT GENERATED ALWAYS AS (
            CASE
                WHEN vigente = TRUE
                THEN id_contrato
                ELSE NULL
...
CREATE TABLE plan_pago (
    ...
    id_venta BIGINT NOT NULL,
    id_estado_plan_pago SMALLINT NOT NULL,
    id_moneda SMALLINT NOT NULL,
    ...
    id_venta_vigente BIGINT GENERATED ALWAYS AS (
            CASE
                WHEN vigente = TRUE
                THEN id_venta
                ELSE NULL
...
CREATE TABLE cuota (
    ...
    id_estado_cuota SMALLINT NOT NULL,
...
CREATE TABLE pago (
  ...
  CREATE TABLE voucher (
    ...
    id_pago BIGINT NOT NULL,
    id_estado_voucher SMALLINT NOT NULL,
...
-- 08.01 COM_ASESORES
CREATE TABLE asesor (
    id_asesor BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,

    id_persona BIGINT NOT NULL,
    id_tipo_asesor SMALLINT NOT NULL,
    id_estado_asesor SMALLINT NOT NULL,
    id_usuario BIGINT,
  ...
  CREATE TABLE asignacion_prospecto (
    ...
    prospecto_vigente BIGINT GENERATED ALWAYS AS (
            CASE
  ...
  CREATE TABLE asignacion_venta (
    ...
    id_venta_principal BIGINT GENERATED ALWAYS AS (
            CASE
                WHEN principal = TRUE
                THEN id_venta
                ELSE NULL
  ...
  CREATE TABLE regla_comision (
    ...
    clave_vigente VARCHAR(180) GENERATED ALWAYS AS (
            CASE
                WHEN activo = TRUE
                     AND fecha_hasta IS NULL
                THEN (COALESCE(id_proyecto)::text || (0)::text, '-',
  ...
  CREATE TABLE comision (
    ...
    id_estado_comision SMALLINT NOT NULL,
    id_moneda SMALLINT NOT NULL,
  ...
  CREATE TABLE pagina (
    ...
    id_estado_publicacion SMALLINT NOT NULL,
...
CREATE TABLE seccion (
  ...
  CREATE TABLE vinculo_multimedia (
    ...
    CONSTRAINT chk_vinculo_destino
        CHECK (
            (
                (id_pagina IS NOT NULL)::int
                +
                (id_seccion IS NOT NULL)::int::int
                +
                (id_elemento IS NOT NULL)::int
            ) = 1
        ),
  ...
  CREATE TABLE consulta_web (
    ...
    id_estado_consulta_web SMALLINT NOT NULL,
...
CREATE TABLE notificacion (
  ...
  CREATE TABLE envio_notificacion (
    ...
    id_estado_envio SMALLINT NOT NULL,
  ...
  CREATE TABLE plantilla (
    ...
    clave_vigente VARCHAR(80) GENERATED ALWAYS AS (
            CASE
                WHEN vigente = TRUE
                     AND activo = TRUE
                     AND fecha_hasta IS NULL
  ...
  CREATE TABLE movimiento (
    ...
    id_estado_movimiento SMALLINT NOT NULL,
...
-- =============================================
-- INDICES ADICIONALES (POSTGRESQL / SUPABASE)
-- =============================================

CREATE INDEX IF NOT EXISTS idx_persona_nombre ON persona (apellido_paterno, apellido_materno, nombre);
CREATE INDEX IF NOT EXISTS idx_doc_persona ON documento_identidad (id_persona);
CREATE INDEX IF NOT EXISTS idx_doc_numero ON documento_identidad (numero);
CREATE INDEX IF NOT EXISTS idx_contacto_persona ON contacto (id_persona);
CREATE INDEX IF NOT EXISTS idx_contacto_valor ON contacto (valor);
CREATE INDEX IF NOT EXISTS idx_dir_persona ON direccion (id_persona);
CREATE INDEX IF NOT EXISTS idx_usuario_estado ON usuario (id_estado_usuario);
CREATE INDEX IF NOT EXISTS idx_asig_rol_usuario ON asignacion_rol (id_usuario);
CREATE INDEX IF NOT EXISTS idx_asig_rol_rol ON asignacion_rol (id_rol);
CREATE INDEX IF NOT EXISTS idx_token_usuario ON token_recuperacion (id_usuario);
CREATE INDEX IF NOT EXISTS idx_token_expiracion ON token_recuperacion (fecha_expiracion);
...
CREATE INDEX IF NOT EXISTS idx_tarifa_busqueda ON tarifa (id_proyecto, id_zona, id_etapa_comercial);
CREATE INDEX IF NOT EXISTS idx_tarifa_vigencia ON tarifa (fecha_desde, fecha_hasta);
CREATE INDEX IF NOT EXISTS idx_ajuste_busqueda ON ajuste_precio (id_proyecto, id_tipo_lote, fecha_desde);
CREATE INDEX IF NOT EXISTS idx_lote_zona ON lote (id_zona);
CREATE INDEX IF NOT EXISTS idx_precio_historial ON precio_lote (id_lote, fecha_desde);
CREATE INDEX IF NOT EXISTS idx_precio_tarifa ON precio_lote (id_tarifa);
CREATE INDEX IF NOT EXISTS idx_precio_ajuste ON precio_lote (id_ajuste);
CREATE INDEX IF NOT EXISTS idx_historial_lote ON historial_lote (id_lote, fecha_cambio);
CREATE INDEX IF NOT EXISTS idx_plano_etapa ON plano_interactivo (id_etapa);
CREATE INDEX IF NOT EXISTS idx_geo_proyecto ON geometria_lote (id_proyecto);
CREATE INDEX IF NOT EXISTS idx_geo_plano_proy ON geometria_lote (id_plano, id_proyecto);
CREATE INDEX IF NOT EXISTS idx_geo_lote_proy ON geometria_lote (id_lote, id_proyecto);
CREATE INDEX IF NOT EXISTS idx_geo_visible ON geometria_lote (id_plano, visible);
CREATE INDEX IF NOT EXISTS idx_geo_orden ON geometria_lote (id_plano, orden_capa);
CREATE INDEX IF NOT EXISTS idx_prospecto_estado ON prospecto (id_estado_prospecto);
CREATE INDEX IF NOT EXISTS idx_prospecto_origen ON prospecto (id_origen_prospecto);
CREATE INDEX IF NOT EXISTS idx_prospecto_fecha ON prospecto (fecha_registro);
CREATE INDEX IF NOT EXISTS idx_interes_prospecto ON interes_comercial (id_prospecto);
CREATE INDEX IF NOT EXISTS idx_interes_proyecto ON interes_comercial (id_proyecto);
CREATE INDEX IF NOT EXISTS idx_interes_moneda ON interes_comercial (id_moneda);
CREATE INDEX IF NOT EXISTS idx_seguimiento_prosp ON seguimiento (id_prospecto, fecha_seguimiento);
CREATE INDEX IF NOT EXISTS idx_seguimiento_proximo ON seguimiento (fecha_proximo);
CREATE INDEX IF NOT EXISTS idx_cliente_alta ON cliente (fecha_alta);
CREATE INDEX IF NOT EXISTS idx_consent_persona ON consentimiento (id_persona, id_tipo_consentimiento);
CREATE INDEX IF NOT EXISTS idx_reserva_lote_estado ON reserva (id_lote, id_estado_reserva);
CREATE INDEX IF NOT EXISTS idx_reserva_persona ON reserva (id_persona);
CREATE INDEX IF NOT EXISTS idx_reserva_estado ON reserva (id_estado_reserva);
CREATE INDEX IF NOT EXISTS idx_reserva_vencimiento ON reserva (fecha_vencimiento);
CREATE INDEX IF NOT EXISTS idx_venta_lote ON venta (id_lote);
CREATE INDEX IF NOT EXISTS idx_venta_res_lote ON venta (id_reserva, id_lote);
CREATE INDEX IF NOT EXISTS idx_venta_res_moneda ON venta (id_reserva, id_moneda);
CREATE INDEX IF NOT EXISTS idx_venta_estado ON venta (id_estado_venta);
CREATE INDEX IF NOT EXISTS idx_venta_modalidad ON venta (id_modalidad_venta);
CREATE INDEX IF NOT EXISTS idx_venta_fecha ON venta (fecha_venta);
CREATE INDEX IF NOT EXISTS idx_part_cliente ON participacion_venta (id_cliente);
CREATE INDEX IF NOT EXISTS idx_contrato_venta ON contrato (id_venta);
CREATE INDEX IF NOT EXISTS idx_contrato_tipo ON contrato (id_tipo_contrato);
CREATE INDEX IF NOT EXISTS idx_doc_contract ON documento_contractual (id_contrato, vigente);
CREATE INDEX IF NOT EXISTS idx_doc_visible ON documento_contractual (visible_cliente);
CREATE INDEX IF NOT EXISTS idx_doc_publicacion ON documento_contractual (fecha_publicacion);
CREATE INDEX IF NOT EXISTS idx_plan_estado ON plan_pago (id_estado_plan_pago);
CREATE INDEX IF NOT EXISTS idx_plan_vigente ON plan_pago (id_venta, vigente);
CREATE INDEX IF NOT EXISTS idx_cuota_estado ON cuota (id_estado_cuota);
CREATE INDEX IF NOT EXISTS idx_cuota_vencimiento ON cuota (fecha_vencimiento);
CREATE INDEX IF NOT EXISTS idx_cuota_plan_fecha ON cuota (id_plan_pago, fecha_vencimiento);
CREATE INDEX IF NOT EXISTS idx_pago_reserva ON pago (id_reserva);
CREATE INDEX IF NOT EXISTS idx_pago_venta ON pago (id_venta);
CREATE INDEX IF NOT EXISTS idx_pago_plan ON pago (id_plan_pago);
CREATE INDEX IF NOT EXISTS idx_pago_estado ON pago (id_estado_pago);
CREATE INDEX IF NOT EXISTS idx_pago_metodo ON pago (id_metodo_pago);
CREATE INDEX IF NOT EXISTS idx_pago_fecha ON pago (fecha_operacion);
CREATE INDEX IF NOT EXISTS idx_pago_operacion ON pago (numero_operacion);
CREATE INDEX IF NOT EXISTS idx_aplicacion_pago_plan ON aplicacion_pago (id_pago, id_plan_pago);
CREATE INDEX IF NOT EXISTS idx_aplicacion_cuota ON aplicacion_pago (id_cuota, id_plan_pago);
CREATE INDEX IF NOT EXISTS idx_aplicacion_plan ON aplicacion_pago (id_plan_pago);
CREATE INDEX IF NOT EXISTS idx_aplicacion_tipo ON aplicacion_pago (id_tipo_aplicacion_pago);
CREATE INDEX IF NOT EXISTS idx_aplicacion_fecha ON aplicacion_pago (fecha_aplicacion);
CREATE INDEX IF NOT EXISTS idx_voucher_pago ON voucher (id_pago);
CREATE INDEX IF NOT EXISTS idx_voucher_estado ON voucher (id_estado_voucher);
CREATE INDEX IF NOT EXISTS idx_voucher_fecha ON voucher (fecha_carga);
CREATE INDEX IF NOT EXISTS idx_voucher_hash ON voucher (hash_archivo);
CREATE INDEX IF NOT EXISTS idx_hist_plan_fecha ON historial_plan (id_plan_pago, fecha_cambio);
CREATE INDEX IF NOT EXISTS idx_hist_plan_estado ON historial_plan (id_estado_nuevo);
CREATE INDEX IF NOT EXISTS idx_hist_plan_usuario ON historial_plan (id_usuario);
CREATE INDEX IF NOT EXISTS idx_asesor_estado ON asesor (id_estado_asesor);
CREATE INDEX IF NOT EXISTS idx_asesor_tipo_estado ON asesor (id_tipo_asesor, id_estado_asesor);
CREATE INDEX IF NOT EXISTS idx_asig_prosp_fecha ON asignacion_prospecto (id_prospecto, fecha_asignacion);
CREATE INDEX IF NOT EXISTS idx_asig_asesor_fecha ON asignacion_prospecto (id_asesor, fecha_asignacion);
CREATE INDEX IF NOT EXISTS idx_asig_venta_asesor ON asignacion_venta (id_asesor, fecha_asignacion);
CREATE INDEX IF NOT EXISTS idx_regla_busqueda ON regla_comision (id_proyecto, id_tipo_asesor, id_modalidad_venta, activo);
CREATE INDEX IF NOT EXISTS idx_regla_vigencia ON regla_comision (fecha_desde, fecha_hasta);
CREATE INDEX IF NOT EXISTS idx_comision_regla ON comision (id_regla_comision);
CREATE INDEX IF NOT EXISTS idx_comision_estado ON comision (id_estado_comision, fecha_generacion);
CREATE INDEX IF NOT EXISTS idx_comision_fecha ON comision (fecha_generacion);
CREATE INDEX IF NOT EXISTS idx_pagina_estado ON pagina (id_estado_publicacion);
CREATE INDEX IF NOT EXISTS idx_pagina_menu ON pagina (mostrar_menu, orden);
CREATE INDEX IF NOT EXISTS idx_pagina_publica ON pagina (fecha_publicacion);
CREATE INDEX IF NOT EXISTS idx_seccion_tipo ON seccion (id_tipo_seccion);
CREATE INDEX IF NOT EXISTS idx_seccion_orden ON seccion (id_pagina, orden);
CREATE INDEX IF NOT EXISTS idx_seccion_visible ON seccion (visible, activo);
CREATE INDEX IF NOT EXISTS idx_elemento_orden ON elemento_seccion (id_seccion, orden);
CREATE INDEX IF NOT EXISTS idx_elemento_visible ON elemento_seccion (visible, activo);
CREATE INDEX IF NOT EXISTS idx_multimedia_tipo ON multimedia (id_tipo_multimedia);
CREATE INDEX IF NOT EXISTS idx_multimedia_hash ON multimedia (hash_archivo);
CREATE INDEX IF NOT EXISTS idx_multimedia_activo ON multimedia (activo);
CREATE INDEX IF NOT EXISTS idx_multimedia_fecha ON multimedia (fecha_creacion);
CREATE INDEX IF NOT EXISTS idx_vinculo_multimedia ON vinculo_multimedia (id_multimedia);
CREATE INDEX IF NOT EXISTS idx_vinculo_pag_orden ON vinculo_multimedia (id_pagina, orden);
CREATE INDEX IF NOT EXISTS idx_vinculo_sec_orden ON vinculo_multimedia (id_seccion, orden);
CREATE INDEX IF NOT EXISTS idx_vinculo_elem_orden ON vinculo_multimedia (id_elemento, orden);
CREATE INDEX IF NOT EXISTS idx_vinculo_uso ON vinculo_multimedia (id_uso_multimedia);
CREATE INDEX IF NOT EXISTS idx_ficha_destacado ON ficha_proyecto (destacado, orden);
CREATE INDEX IF NOT EXISTS idx_ficha_activo ON ficha_proyecto (activo);
CREATE INDEX IF NOT EXISTS idx_consulta_estado ON consulta_web (id_estado_consulta_web);
CREATE INDEX IF NOT EXISTS idx_consulta_proyecto ON consulta_web (id_proyecto);
CREATE INDEX IF NOT EXISTS idx_consulta_prospecto ON consulta_web (id_prospecto);
CREATE INDEX IF NOT EXISTS idx_consulta_fecha ON consulta_web (fecha_recepcion);
CREATE INDEX IF NOT EXISTS idx_consulta_estado_fec ON consulta_web (id_estado_consulta_web, fecha_recepcion);
CREATE INDEX IF NOT EXISTS idx_consulta_correo ON consulta_web (correo);
CREATE INDEX IF NOT EXISTS idx_consulta_telefono ON consulta_web (telefono);
CREATE INDEX IF NOT EXISTS idx_notif_persona_lect ON notificacion (id_persona, fecha_lectura);
CREATE INDEX IF NOT EXISTS idx_notif_tipo ON notificacion (id_tipo_notificacion);
CREATE INDEX IF NOT EXISTS idx_notif_fecha ON notificacion (fecha_generacion);
CREATE INDEX IF NOT EXISTS idx_notif_activo ON notificacion (activo);
CREATE INDEX IF NOT EXISTS idx_envio_estado_prog ON envio_notificacion (id_estado_envio, fecha_programada);
CREATE INDEX IF NOT EXISTS idx_envio_canal ON envio_notificacion (id_canal_notificacion);
CREATE INDEX IF NOT EXISTS idx_envio_intento ON envio_notificacion (fecha_ultimo_intento);
CREATE INDEX IF NOT EXISTS idx_plantilla_canal ON plantilla (id_canal_notificacion);
CREATE INDEX IF NOT EXISTS idx_plantilla_vigencia ON plantilla (fecha_desde, fecha_hasta);
CREATE INDEX IF NOT EXISTS idx_pref_persona_hab ON preferencia (id_persona, habilitado);
CREATE INDEX IF NOT EXISTS idx_pref_tipo ON preferencia (id_tipo_notificacion);
CREATE INDEX IF NOT EXISTS idx_pref_canal ON preferencia (id_canal_notificacion);
CREATE INDEX IF NOT EXISTS idx_categoria_padre ON categoria_financiera (id_categoria_padre, id_tipo_movimiento);
CREATE INDEX IF NOT EXISTS idx_categoria_tipo_act ON categoria_financiera (id_tipo_movimiento, activo);
CREATE INDEX IF NOT EXISTS idx_cuenta_moneda ON cuenta_financiera (id_moneda);
CREATE INDEX IF NOT EXISTS idx_cuenta_tipo_act ON cuenta_financiera (id_tipo_cuenta, activo);
CREATE INDEX IF NOT EXISTS idx_movimiento_cuenta ON movimiento (id_cuenta, fecha_movimiento);
CREATE INDEX IF NOT EXISTS idx_movimiento_categoria ON movimiento (id_categoria, fecha_movimiento);
CREATE INDEX IF NOT EXISTS idx_movimiento_estado ON movimiento (id_estado_movimiento);
CREATE INDEX IF NOT EXISTS idx_movimiento_fecha ON movimiento (fecha_movimiento);
CREATE INDEX IF NOT EXISTS idx_transf_origen_fecha ON transferencia (id_cuenta_origen, fecha_transferencia);
CREATE INDEX IF NOT EXISTS idx_transf_dest_fecha ON transferencia (id_cuenta_destino, fecha_transferencia);
CREATE INDEX IF NOT EXISTS idx_transf_estado ON transferencia (id_estado_movimiento);
CREATE INDEX IF NOT EXISTS idx_transf_fecha ON transferencia (fecha_transferencia);
CREATE INDEX IF NOT EXISTS idx_saldo_fecha ON saldo_inicial (fecha_saldo);
CREATE INDEX IF NOT EXISTS idx_evento_usuario ON evento_auditoria (id_usuario, fecha_evento);
CREATE INDEX IF NOT EXISTS idx_evento_modulo ON evento_auditoria (modulo, fecha_evento);
CREATE INDEX IF NOT EXISTS idx_evento_accion ON evento_auditoria (modulo, accion, fecha_evento);
CREATE INDEX IF NOT EXISTS idx_evento_entidad ON evento_auditoria (entidad, clave_entidad, fecha_evento);
CREATE INDEX IF NOT EXISTS idx_evento_resultado ON evento_auditoria (resultado, fecha_evento);
CREATE INDEX IF NOT EXISTS idx_evento_solicitud ON evento_auditoria (codigo_solicitud);
CREATE INDEX IF NOT EXISTS idx_evento_ip ON evento_auditoria (ip_origen, fecha_evento);
CREATE INDEX IF NOT EXISTS idx_evento_fecha ON evento_auditoria (fecha_evento);
